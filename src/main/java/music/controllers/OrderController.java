...
public class OrderController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        System.out.println("code in orderControll dopost");
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        System.out.println("code in catalogControll dopost");
        String requestURI = request.getRequestURI();
    ...
    private String processUser(HttpServletRequest request,
        ...
        if (UserDB.emailExists(email)) {
            UserDB.update(user);
            System.out.println("code in update user");
        } else {
            UserDB.insert(user);
        }
    ...
    private String displayInvoice(HttpServletRequest request,
                                  HttpServletResponse response) {
        System.out.println("code in display invoice");
        HttpSession session = request.getSession();
...
//        String from = "confirmation@freshcornrecords.com";
        String from = "thangle300403@gmail.com";
        String subject = "Order Confirmation";
        String body = "Dear " + user.getFirstName() + ",\n\n" +
                "Big thanks for choosing us to be your sports equipment game-changer! Your order, packed with top-notch quality gear, is revved up and ready to hit the road. Anticipate the thrill of your package arriving right at your doorstep in a swift 3-5 business days. \n" +
                "Your trust in our lineup means the world to us. As you eagerly await the delivery, envision an exhilarating sports experience ahead. Play hard, play smart, and revel in every winning moment. \n" +
                "Once again, a massive thank you for choosing us as your go-to sports equipment hub. Here's to an action-packed day ahead, fueled by your passion for the game! \n" +
