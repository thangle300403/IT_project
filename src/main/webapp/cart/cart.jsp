...
<%--                                    <input type="submit" value="Update">--%>
                                    <button class="buttonup" type="submit">
                                        <p>UPDATE</p>
                                    </button>
                                </form>
                            </td>
                            ...
                            <td>
                                <form action="<c:url value='/order/removeItem'/>" method="post">
                                    <input type="hidden" name="productCode"
                                           value="<c:out value='${item.product.code}'/>">
                                    <button type="submit" value="Remove" class="buttonrm">
...
<%--        </form>--%>
        <button class="cta" onclick="window.location.href='<c:url value='/catalog'/>';" type="button">
        ...
        <c:if test="${emptyCart == null}">
            ...
            <form action="<c:url value='/order/checkUser'/>" method="post">
                <button type="submit"  class="btn1" style="max-width: 200px;">
                    CHECK OUT
                </button>
            </form>
<%--            <form action="<c:url value='/order/checkUser'/>" method="post">--%>
